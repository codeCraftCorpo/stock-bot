using a config file too much was a mistake. it made it ez to change variables all at once, but adding new stuff is impossible. passing variables as parameters 
